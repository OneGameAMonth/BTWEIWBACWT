...
public class CameraFade : MonoBehaviour
{
    ...
    public Action m_OnFadeDelayFinish = null;
    ...
    void OnGUI()
    {
        ...
        {
            if (instance.m_OnFadeDelayFinish != null)
            {
                instance.m_OnFadeDelayFinish();
                instance.m_OnFadeDelayFinish = null;
            }
    ...
    {
        StartAlphaFade(newScreenOverlayColor, isFadeIn, fadeDuration, 0, null);
    }
    ...
    {
        StartAlphaFade(newScreenOverlayColor, isFadeIn, fadeDuration, fadeDelay, null);
    }
    ...
    {
        StartAlphaFade(newScreenOverlayColor, isFadeIn, fadeDuration, fadeDelay, OnFadeFinish, null);
    }
    ...
    /// On fade finish, doWork().
    /// </param>
    public static void StartAlphaFade(Color newScreenOverlayColor, bool isFadeIn, float fadeDuration, float fadeDelay, Action OnFadeFinish, Action OnFadeDelayFinish)
    {
        ...
        else
        {
            ...
            instance.m_OnFadeDelayFinish = OnFadeDelayFinish;
            ...
            instance.m_DeltaColor = (instance.m_TargetScreenOverlayColor - instance.m_CurrentScreenOverlayColor) / (fadeDuration + fadeDuration);
        }
    }
